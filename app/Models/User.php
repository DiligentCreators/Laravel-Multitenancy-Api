...
use App\Notifications\Tenant\Auth\ResetPassword;
...
class User extends Authenticatable
{
    ...
    use BelongsToTenant, HasApiTokens, HasFactory, HasRoles, Notifiable, Searchable, SoftDeletes;

    protected $guard_name = 'tenant-api';
